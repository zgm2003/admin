...
export const menuIcons = {
  ...
  'lucide:database-zap': { component: DatabaseZap, label: '配置缓存代际' },
  ...
  'lucide:sliders-horizontal': { component: SlidersHorizontal, label: '系统设置' },
