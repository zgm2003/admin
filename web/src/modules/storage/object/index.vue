  ...
  <section class="storage-page management-page">
    ...
    <el-tabs v-model="activeTab" @tab-change="switchTab">
      <el-tab-pane name="config" :label="t('storage.configTab')" data-testid="storage-config-tab">
        <Search v-model="configSearchModel" :fields="configSearchFields" :query-label="t('storage.search')" :reset-label="t('storage.reset')" query-test-id="storage-config-search" reset-test-id="storage-config-reset" @query="searchConfigs" @reset="resetConfigs" />
      ...
      <el-tab-pane name="rules" :label="t('storage.rulesTab')" data-testid="storage-rules-tab">
        <Search v-model="ruleSearchModel" :fields="ruleSearchFields" :query-label="t('storage.search')" :reset-label="t('storage.reset')" query-test-id="storage-rule-search" reset-test-id="storage-rule-reset" @query="searchRules" @reset="resetRules" />
