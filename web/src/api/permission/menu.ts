...
export function createMenu(input: CreateMenuInput): Promise<MenuIDResult> {
    return request<MenuIDResult>({method: 'POST', url: '/api/admin/v1/menus', data: input})
}

export function updateMenu(id: number, input: UpdateMenuInput): Promise<MenuIDResult> {
    return request<MenuIDResult>({method: 'PUT', url: `/api/admin/v1/menus/${id}`, data: input})
}

export function updateMenuStatus(id: number, isEnabled: YesNo): Promise<MenuStatusResult> {
    return request<MenuStatusResult>({method: 'PATCH', url: `/api/admin/v1/menus/${id}/status`, data: {isEnabled}})
}

export function deleteMenu(id: number): Promise<MenuIDResult> {
    return request<MenuIDResult>({method: 'DELETE', url: `/api/admin/v1/menus/${id}`})
}
...
const menuNodeKeys = [
    ...
    'i18nKey', 'path', 'componentPath', 'icon', 'remark', 'sortOrder', 'isEnabled', 'isHidden', 'isProtected',
