...
export interface UploadRule { id:number; platformId:number; platformCode:string; platformName:string; codes:string[]; name:string; cosConfigId:number; cosConfigName:string; maxFileSizeBytes:number; allowedExtensions:string[]; allowedMimeTypes:string[]; accessMode:'private'|'public'; isEnabled:YesNo; remark:string; createdAt:string; updatedAt:string }
export interface UploadRuleQuery extends PageRequest { platformId?:number; cosConfigId?:number; keyword?:string; isEnabled?:YesNo }
export interface UploadRuleInput { platformId?:number; codes?:string[]; name:string; cosConfigId:number; maxFileSizeBytes:number; allowedExtensions:string[]; allowedMimeTypes:string[]; accessMode:'private'|'public'; isEnabled?:YesNo; remark:string }
