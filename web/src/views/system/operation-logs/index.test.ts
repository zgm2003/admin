...
import * as operationLogAPI from '../../../api/operation-log'
import type { OperationLogItem } from '../../../api/operation-log.contract'
import { YesNo } from '../../../enums/yes-no'
import { appI18n, setLocale } from '../../../i18n'
import OperationLogs from './index.vue'

vi.mock('../../../api/operation-log', () => ({ getOperationLogs: vi.fn() }))
...
describe('operation logs', () => {
	...
	it('loads logs and submits exact filters and pagination', async () => {
		...
		wrapper.findComponent({ name: 'ElSelect' }).vm.$emit('update:modelValue', YesNo.No)
