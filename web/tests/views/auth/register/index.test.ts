...
import { getAuthPolicy, register } from '@src/api/auth'
import { appI18n } from '@src/i18n'
import { pinia } from '@src/store'
import { useAuthStore } from '@src/store/auth'
import RegisterPage from '@src/views/auth/register/index.vue'

vi.mock('@src/api/auth', () => ({ getAuthPolicy: vi.fn(), register: vi.fn() }))
