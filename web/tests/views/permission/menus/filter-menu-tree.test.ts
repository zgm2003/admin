...
const action = (id: number, code: string, name: string): ManagedMenuNode => ({ id, platformId: 1, platformCode: 'admin', platformName: 'Admin', parentId: 2, menuType: 'action', name, code, i18nKey: null, path: null, componentPath: null, icon: null, remark: null, sortOrder: id, isEnabled: 1, isHidden: 1, isProtected: 0, createdAt: '2026-08-19T02:00:00Z', updatedAt: '2026-08-19T02:00:00Z', children: [] })
