...
func TestBuildRouterRegistersFoundationRoutesOnce(t *testing.T) {
	...
	want := map[string]int{
		...
		"GET /api/v1/access":                                            1,
		"POST /api/v1/storage/upload-credential":                        1,
		"GET /api/admin/v1/permission/authplatform":                     1,
		"GET /api/admin/v1/permission/authplatform/deployment":          1,
		"GET /api/admin/v1/user/profile":                                1,
		"POST /api/admin/v1/permission/authplatform":                    1,
		"POST /api/admin/v1/user/password":                              1,
		"POST /api/admin/v1/user/password/set":                          1,
		"PUT /api/admin/v1/permission/authplatform/:id":                 1,
		"PUT /api/admin/v1/user/profile":                                1,
		"PATCH /api/admin/v1/permission/authplatform/:id/status":        1,
		"DELETE /api/admin/v1/permission/authplatform/:id":              1,
		"GET /api/admin/v1/permission/menu":                             1,
		"POST /api/admin/v1/permission/menu":                            1,
		"PUT /api/admin/v1/permission/menu/:id":                         1,
		"PATCH /api/admin/v1/permission/menu/:id/status":                1,
		"DELETE /api/admin/v1/permission/menu/:id":                      1,
		"POST /api/admin/v1/permission/menu/access-cache/rebuild":       1,
		"GET /api/admin/v1/permission/role":                             1,
		"POST /api/admin/v1/permission/role":                            1,
		"PUT /api/admin/v1/permission/role/:id":                         1,
		"PATCH /api/admin/v1/permission/role/:id/status":                1,
		"PATCH /api/admin/v1/permission/role/:id/default":               1,
		"DELETE /api/admin/v1/permission/role/:id":                      1,
		"GET /api/admin/v1/permission/role/:id/permission":              1,
		"PUT /api/admin/v1/permission/role/:id/permission":              1,
		"GET /api/admin/v1/user/account":                                1,
		"GET /api/admin/v1/user/account/role-options":                   1,
		"PUT /api/admin/v1/user/account/:id":                            1,
		"PATCH /api/admin/v1/user/account/:id/status":                   1,
		...
		"PUT /api/admin/v1/system/dictionary/:id":                       1,
		"PUT /api/admin/v1/system/dictionary/:id/item/:itemId":          1,
		"PATCH /api/admin/v1/system/dictionary/:id/status":              1,
		"PATCH /api/admin/v1/system/dictionary/:id/item/:itemId/status": 1,
		"DELETE /api/admin/v1/system/dictionary/:id":                    1,
		"DELETE /api/admin/v1/system/dictionary/:id/item/:itemId":       1,
		"GET /api/admin/v1/user/loginlog":                               1,
		"GET /api/admin/v1/user/loginlog/page-init":                     1,
		"GET /api/admin/v1/storage/cosconfig":                           1,
		"POST /api/admin/v1/storage/cosconfig":                          1,
		"GET /api/admin/v1/storage/cosconfig/:id":                       1,
		"PUT /api/admin/v1/storage/cosconfig/:id":                       1,
		"PATCH /api/admin/v1/storage/cosconfig/:id/status":              1,
		"POST /api/admin/v1/storage/cosconfig/:id/test":                 1,
		"DELETE /api/admin/v1/storage/cosconfig/:id":                    1,
		"GET /api/admin/v1/storage/uploadrule":                          1,
		"GET /api/admin/v1/storage/uploadrule/page-init":                1,
		"POST /api/admin/v1/storage/uploadrule":                         1,
		"GET /api/admin/v1/storage/uploadrule/:id":                      1,
		"PUT /api/admin/v1/storage/uploadrule/:id":                      1,
		"PATCH /api/admin/v1/storage/uploadrule/:id/status":             1,
		"DELETE /api/admin/v1/storage/uploadrule/:id":                   1,
	...
	request := httptest.NewRequest(http.MethodGet, "/api/admin/v1/permission/menu", nil)
	...
	for _, protectedPath := range []struct {
		...
		{method: http.MethodGet, path: "/api/admin/v1/permission/menu"},
	} {
		recorder = httptest.NewRecorder()
