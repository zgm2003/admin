...
func createLegacyAdminFixture(t *testing.T, db *gorm.DB, ctx context.Context) {
	...
	statements := []string{
		...
		`CREATE TABLE rbac_role (id BIGINT PRIMARY KEY, code VARCHAR(64) NOT NULL, name VARCHAR(64) NOT NULL, is_default SMALLINT NOT NULL DEFAULT 0, is_enabled SMALLINT NOT NULL DEFAULT 1, created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, deleted_at TIMESTAMPTZ NULL)`,
		...
		`CREATE TABLE rbac_user_role (id BIGINT PRIMARY KEY, user_id BIGINT NOT NULL, role_id BIGINT NOT NULL, created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, deleted_at TIMESTAMPTZ NULL)`,
		`CREATE TABLE rbac_role_menu (id BIGINT PRIMARY KEY, role_id BIGINT NOT NULL, menu_id BIGINT NOT NULL, created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, deleted_at TIMESTAMPTZ NULL)`,
		`CREATE TABLE rbac_access_version (user_id BIGINT PRIMARY KEY, version BIGINT NOT NULL DEFAULT 1, created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP)`,
		...
		`INSERT INTO rbac_role (id, code, name, is_default) VALUES (21, 'admin', 'Admin', 1)`,
		`INSERT INTO rbac_menu (id, platform_id, menu_type, name, code) VALUES (31, 1, 'page', 'Users', 'users')`,
		`INSERT INTO rbac_user_role (id, user_id, role_id) VALUES (61, 11, 21)`,
		`INSERT INTO rbac_role_menu (id, role_id, menu_id) VALUES (71, 21, 31)`,
