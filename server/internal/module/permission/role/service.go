...
func (s *Service) UpdateStatus(ctx context.Context, id int64, value yesno.Value) error {
	...
	err := s.mutateAffectedUsers(ctx, id, func(mutationCtx context.Context, repository *Repository, candidates []permissionstate.Version) (bool, map[int64]int64, error) {
...
func (s *Service) UpdatePermissions(ctx context.Context, roleID int64, menuIDs []int64) (int64, error) {
	...
	err := s.mutateAffectedUsers(ctx, roleID, func(mutationCtx context.Context, repository *Repository, candidates []permissionstate.Version) (bool, map[int64]int64, error) {
...
type roleAccessMutation func(context.Context, *Repository, []permissionstate.Version) (bool, map[int64]int64, error)
...
func equalAccessVersions(left, right []permissionstate.Version) bool {
...
func accessUserIDs(versions []permissionstate.Version) []int64 {
