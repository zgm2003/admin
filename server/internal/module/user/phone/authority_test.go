...
func TestAuthorityCoordinatorCommitsFreshGenerationAfterSuccessfulMutationWhenRequestIsCanceled(t *testing.T) {
	...
	prior := authstate.UserFact{UserID: userID, Generation: "phone-prior", IsEnabled: true}
...
func openPhoneAuthorityRedis(t *testing.T) *projectredis.Client {
	t.Helper()
	if testing.Short() {
