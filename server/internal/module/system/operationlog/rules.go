...
var routeRules = []RouteRule{
	...
	{http.MethodPut, "/api/admin/v1/user/profile", "account", "user.profile.update", true, true},
	{http.MethodPost, "/api/admin/v1/user/password", "account", "account.password.change", true, true},
	...
	{http.MethodPut, "/api/admin/v1/message/mail/rate-limit-policy/:key", "mail", "mail.rate-limit.update", true, true},
}
