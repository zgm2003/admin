...
type Role struct {
	...
	IsDefault yesno.Value    `gorm:"column:is_default;type:smallint;not null;default:0;check:ck_sys_role_is_default,is_default IN (0,1)"`
	IsEnabled yesno.Value    `gorm:"column:is_enabled;type:smallint;not null;default:1;check:ck_sys_role_is_enabled,is_enabled IN (0,1)"`
