...
func validCreate(platformID, configID int64, code string, enabled yesno.Value) CreateInput {
	return CreateInput{PlatformID: platformID, Code: code, Name: strings.ToUpper(code), CosConfigID: configID, MaxFileSizeBytes: 1024, AllowedExtensions: []string{"png"}, AllowedMimeTypes: []string{"image/png"}, AccessMode: "private", IsEnabled: enabled}
}
...
func openRuleDatabase(t *testing.T) (*gorm.DB, context.Context) {
	...
	if err := db.WithContext(ctx).Exec(`
		...
		CREATE TABLE storage_upload_rule (id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, platform_id BIGINT NOT NULL, code VARCHAR(64) NOT NULL, name VARCHAR(128) NOT NULL, cos_config_id BIGINT NOT NULL, max_file_size_bytes BIGINT NOT NULL, allowed_extensions TEXT[] NOT NULL, allowed_mime_types TEXT[] NOT NULL, access_mode VARCHAR(16) NOT NULL, is_enabled SMALLINT NOT NULL, remark VARCHAR(512) NOT NULL DEFAULT '', created_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, deleted_at TIMESTAMPTZ);
