...
func (s stubRateLimitPolicyStore) Update(context.Context, int64, RateLimitPolicyInput) (RateLimitCatalog, error) {
	return s.catalog, s.err
}

func defaultPolicyCatalog() RateLimitCatalog {
	return RateLimitCatalog{PlatformID: 1, Version: 1, Policies: ratelimitpolicy.FixedRateLimitPolicies()}
}
...
func policyCatalogWith(overrides map[string][2]int) RateLimitCatalog {
	...
	return RateLimitCatalog{PlatformID: 1, Version: 1, Policies: policies}
}
...
func policyCatalogWithout(key string) RateLimitCatalog {
	...
	return RateLimitCatalog{PlatformID: 1, Version: 1, Policies: filtered}
}
