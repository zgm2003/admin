...
func TestBuildMenuIndexBuildsStableTreeWithNonNilLeafChildren(t *testing.T) {
	...
	menus := []Menu{
		{ID: 4, PlatformID: 1, ParentID: int64Pointer(2), MenuType: TypeAction, Name: "修改角色", Code: "rbac:role:update", SortOrder: 10, IsEnabled: yesno.Yes, IsHidden: yesno.Yes, CreatedAt: now, UpdatedAt: now},
		{ID: 3, PlatformID: 1, ParentID: int64Pointer(2), MenuType: TypeAction, Name: "删除角色", Code: "rbac:role:delete", SortOrder: 20, IsEnabled: yesno.Yes, IsHidden: yesno.Yes, CreatedAt: now, UpdatedAt: now},
		{ID: 2, PlatformID: 1, ParentID: int64Pointer(1), MenuType: TypePage, Name: "角色管理", Code: "rbac:role:list", I18nKey: stringPointer("navigation.accessRoles"), Path: &pagePath, ComponentPath: &componentPath, SortOrder: 10, IsEnabled: yesno.Yes, CreatedAt: now, UpdatedAt: now},
