...
\restrict ajs2UeeCXYZ4Y03hy0rGMFWWdmp8C50jf2zJnQevCsfshWPfElbg9arqpgggkfA
...
--
-- Name: message_notification_dispatch_outbox; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.message_notification_dispatch_outbox (
    id bigint NOT NULL,
...
--
-- Name: message_notification_dispatch_outbox_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.message_notification_dispatch_outbox ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.message_notification_dispatch_outbox_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: message_notification_dispatch_outbox message_notification_dispatch_outbox_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.message_notification_dispatch_outbox
    ADD CONSTRAINT message_notification_dispatch_outbox_pkey PRIMARY KEY (id);
...
--
-- Name: ix_message_notification_dispatch_pending; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX ix_message_notification_dispatch_pending ON public.message_notification_dispatch_outbox USING btree (available_at, id) WHERE (published_at IS NULL);
...
--
-- Name: ux_message_notification_dispatch_batch; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_message_notification_dispatch_batch ON public.message_notification_dispatch_outbox USING btree (task_id, batch_no);
...
--
-- Name: message_notification_dispatch_outbox fk_message_notification_dispatch_task; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.message_notification_dispatch_outbox
    ADD CONSTRAINT fk_message_notification_dispatch_task FOREIGN KEY (task_id) REFERENCES public.message_notification_task(id) ON DELETE CASCADE;
...
\unrestrict ajs2UeeCXYZ4Y03hy0rGMFWWdmp8C50jf2zJnQevCsfshWPfElbg9arqpgggkfA
